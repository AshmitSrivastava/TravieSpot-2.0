    ...
    return (
        <>
            <Carousel responsive={responsive} autoPlay={true} autoPlaySpeed={1000} infinite={true}>
                <div><img src={Sec2_img1} style={imageStyle} alt="Image 1" /></div>
                <div><img src={Sec2_img2} style={imageStyle} alt="Image 2" /></div>
                <div><img src={Sec2_img3} style={imageStyle} alt="Image 3" /></div>
                <div><img src={Sec2_img1} style={imageStyle} alt="Image 1" /></div>
                <div><img src={Sec2_img2} style={imageStyle} alt="Image 2" /></div>
                <div><img src={Sec2_img3} style={imageStyle} alt="Image 3" /></div>
            </Carousel>
